...
import { CardActions, CardActionArea, CardContent, CardMedia, Grid, Typography, Avatar, Box } from "@mui/material";
                        ...
                        <Grid item xs={12} sm={7} md={5} lg={4} xl={3}>
                            <CardActionArea>
                                <CardMedia
                                    ...
                                    alt=""
                                    image={
                                        dashboardData && dashboardData.data && dashboardData.data.nannyPhotoUrl
                            ...
                            <CardActions sx={{ display: "flex", justifyContent: "center" }}>
                                <Button
                                    ...
                                    color="primary"
                                    onClick={() => {
                                        navigate(`/nanny/${jobData?.data?.nannyId}`, { state: { childId: selectedChild?._id } });
                                    }}
                                >
                                    View Nanny Details
                                </Button>
